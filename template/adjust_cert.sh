#!/bin/bash
#curl -s https://raw.githubusercontent.com/ricardoelena/SDP_TempCertGen/main/certGen.sh |  sudo bash -s  `hostname` rosebud ricardo.elena@appgate.com
#curl -s https://raw.githubusercontent.com/ricardoelena/SDP_TempCertGen/main/certGen.sh -o certGen.sh &&  sudo bash certGen.sh `hostname` rosebud ricardo.elena@appgate.com
